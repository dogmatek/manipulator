...
import ru.kmvinvest.repositories.LogRepository;
...
public class LogService {
    ...
    private final static String KEY_LOGGEDSERVICE = "manipulator-iot";
    ...
    // Добавление в кафку и вывод в консоль
    public void addAndSout(String message) {
